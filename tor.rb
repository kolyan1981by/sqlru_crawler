...
class Tor
  ...
  def get_current_ip_address
    ...
    #a.get('http://api.ipify.org?format=json').body.chomp #https://wtfismyip.com/text
  ...
  def tor_switch_endpoint
    ...
    localhost.cmd('AUTHENTICATE "kolyan"') { |c| print c; throw "Cannot authenticate to Tor" if c != "250 OK\n" }
